""" This Module contain methods to interacte with the authy app """
...
def send_authy_one_touch_request(authy_user_id, email=None):
    ...
    response = client.one_touch.send_request(authy_user_id, 'Request to log in to Twilio demo app', details=details)
...
def authy_user_has_app(authy_user_id):
    ...
    print('authy_user: ',authy_user.content['status'])
    try:
